...
/// Keys: name_surprise + name_&lt;conceptKey&gt; for all 24 concepts.
/// </summary>
public static class Strings
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> _tables = new(StringComparer.OrdinalIgnoreCase)
    {
        ["ENG"] = new() {
            ...
            ["name_sanctuary"]="Sanctuary", ["name_pilgrim"]="Pilgrim's Road", ["name_beast"]="Beast Trail",
            ["name_labyrinth"]="Labyrinth", ["name_oneway"]="The Narrow Way", ["name_gamble"]="Gambler's Den",
            ["name_smuggler"]="Smuggler's Cache", ["name_hoard"]="Dragon's Hoard" },
        ["KOR"] = new() {
            ...
            ["name_sanctuary"]="안식처", ["name_pilgrim"]="순례길", ["name_beast"]="야수의 길",
            ["name_labyrinth"]="미궁", ["name_oneway"]="외길", ["name_gamble"]="도박장",
            ["name_smuggler"]="밀수꾼의 소굴", ["name_hoard"]="용의 둥지" },
        ["JPN"] = new() {
            ...
            ["name_sanctuary"]="安息の地", ["name_pilgrim"]="巡礼の道", ["name_beast"]="獣道",
            ["name_labyrinth"]="迷宮", ["name_oneway"]="一本道", ["name_gamble"]="賭博場",
            ["name_smuggler"]="密輸商の隠し場", ["name_hoard"]="竜の宝物庫" },
        ["ZHS"] = new() {
            ...
            ["name_sanctuary"]="避难所", ["name_pilgrim"]="朝圣之路", ["name_beast"]="野兽小径",
            ["name_labyrinth"]="迷宫", ["name_oneway"]="独径", ["name_gamble"]="赌徒巢穴",
            ["name_smuggler"]="走私者密窖", ["name_hoard"]="巨龙宝库" },
        ["ZHT"] = new() {
            ...
            ["name_sanctuary"]="避難所", ["name_pilgrim"]="朝聖之路", ["name_beast"]="野獸小徑",
            ["name_labyrinth"]="迷宮", ["name_oneway"]="獨徑", ["name_gamble"]="賭徒巢穴",
            ["name_smuggler"]="走私者密窖", ["name_hoard"]="巨龍寶庫" },
        ["FRA"] = new() {
            ...
            ["name_sanctuary"]="Sanctuaire", ["name_pilgrim"]="Chemin du Pèlerin", ["name_beast"]="Piste des Bêtes",
            ["name_labyrinth"]="Labyrinthe", ["name_oneway"]="Voie Étroite", ["name_gamble"]="Antre du Joueur",
            ["name_smuggler"]="Cache du Contrebandier", ["name_hoard"]="Trésor du Dragon" },
        ["DEU"] = new() {
            ...
            ["name_sanctuary"]="Zuflucht", ["name_pilgrim"]="Pilgerpfad", ["name_beast"]="Bestienpfad",
            ["name_labyrinth"]="Labyrinth", ["name_oneway"]="Der Schmale Pfad", ["name_gamble"]="Spielerhöhle",
            ["name_smuggler"]="Schmugglerversteck", ["name_hoard"]="Drachenhort" },
        ["ESP"] = new() {
            ...
            ["name_sanctuary"]="Santuario", ["name_pilgrim"]="Senda del Peregrino", ["name_beast"]="Senda de las Bestias",
            ["name_labyrinth"]="Laberinto", ["name_oneway"]="Senda Estrecha", ["name_gamble"]="Guarida del Jugador",
            ["name_smuggler"]="Alijo del Contrabandista", ["name_hoard"]="Tesoro del Dragón" },
        ["SPA"] = new() {
            ["name_surprise"]="Sorpresa", ["name_wanderer"]="Senda del Errante", ["name_market"]="Calle del Mercado",
            ["name_woods"]="Bosque Tranquilo", ["name_trove"]="Ruta del Tesoro", ["name_story"]="Senda del Narrador",
            ["name_balanced"]="Equilibrado", ["name_crossroads"]="Encrucijada", ["name_hunt"]="Cotos de Caza",
        ...
        ["ITA"] = new() {
            ...
            ["name_sanctuary"]="Santuario", ["name_pilgrim"]="Via del Pellegrino", ["name_beast"]="Sentiero delle Bestie",
            ["name_labyrinth"]="Labirinto", ["name_oneway"]="Via Stretta", ["name_gamble"]="Covo del Giocatore",
            ["name_smuggler"]="Nascondiglio del Contrabbandiere", ["name_hoard"]="Tesoro del Drago" },
        ["RUS"] = new() {
            ...
            ["name_sanctuary"]="Убежище", ["name_pilgrim"]="Путь паломника", ["name_beast"]="Звериная тропа",
            ["name_labyrinth"]="Лабиринт", ["name_oneway"]="Узкий путь", ["name_gamble"]="Логово игрока",
            ["name_smuggler"]="Тайник контрабандиста", ["name_hoard"]="Драконье логово" },
        ["PTB"] = new() {
            ...
            ["name_sanctuary"]="Santuário", ["name_pilgrim"]="Caminho do Peregrino", ["name_beast"]="Trilha das Feras",
            ["name_labyrinth"]="Labirinto", ["name_oneway"]="Caminho Estreito", ["name_gamble"]="Covil do Apostador",
            ["name_smuggler"]="Esconderijo do Contrabandista", ["name_hoard"]="Tesouro do Dragão" },
        ["POR"] = new() {
            ["name_surprise"]="Surpresa", ["name_wanderer"]="Caminho do Andarilho", ["name_market"]="Rua do Mercado",
            ["name_woods"]="Bosque Silencioso", ["name_trove"]="Trilha do Tesouro", ["name_story"]="Caminho do Contador",
            ["name_balanced"]="Equilibrado", ["name_crossroads"]="Encruzilhada", ["name_hunt"]="Terreno de Caça",
        ...
        ["POL"] = new() {
            ...
            ["name_sanctuary"]="Sanktuarium", ["name_pilgrim"]="Szlak Pielgrzyma", ["name_beast"]="Zwierzęcy Szlak",
            ["name_labyrinth"]="Labirynt", ["name_oneway"]="Wąska Ścieżka", ["name_gamble"]="Kryjówka Hazardzisty",
            ["name_smuggler"]="Skrytka Przemytnika", ["name_hoard"]="Smoczy Skarbiec" },
        ["TUR"] = new() {
            ...
            ["name_sanctuary"]="Sığınak", ["name_pilgrim"]="Hac Yolu", ["name_beast"]="Canavar İzi",
            ["name_labyrinth"]="Labirent", ["name_oneway"]="Dar Yol", ["name_gamble"]="Kumarbaz İni",
            ["name_smuggler"]="Kaçakçı Zulası", ["name_hoard"]="Ejderha Hazinesi" },
        ["THA"] = new() {
            ...
            ["name_sanctuary"]="สถานพักพิง", ["name_pilgrim"]="เส้นทางแสวงบุญ", ["name_beast"]="เส้นทางอสูร",
            ["name_labyrinth"]="เขาวงกต", ["name_oneway"]="ทางแคบ", ["name_gamble"]="รังนักพนัน",
            ["name_smuggler"]="คลังลับนักลักลอบ", ["name_hoard"]="ขุมทรัพย์มังกร" },
    };
}
